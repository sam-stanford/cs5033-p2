...
\todo{handles read and writes of all patient info}
- uses authentication
- handles all info, as business requirements coulc changed
- ref eval sect which describes the 2 vs 1 service tradeoff
