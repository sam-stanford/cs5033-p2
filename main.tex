...
\title{
    \huge{Architecture-Driven Development} \\
    \includegraphics[scale = 0.30, trim={0 3cm 0 0}, clip]{st-andrews-logo.png} 
}
\author{ 170002815 $\cdot$ MATRIC NO $\cdot$ MATRIC NO $\cdot$ MATRIC NO \vspace{3mm} \\ \\ CS5033 $\cdot$ Practical 2}
\date{22 March 2022}
...
% \missingfigure{WHAT FIGURE SHOULD BE}
...
\section{Requirements Analysis \& Assumptions}
